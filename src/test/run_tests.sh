...
echo ""
echo ""
python test_klarg.py --some-number 10 --not-number 1a --number-no-args  -n
echo ""
echo ""
...
echo ""
echo ""
python test_klarg_command.py --this-should-not-work test --some-number 10 --not-number 1a --number-no-args  -n
echo ""
echo ""
